  ...
  */
  ...
  return (
    <div className='bg-gray-100 h-screen flex flex-col overflow-hidden'>
      ...
      />
      <div className="flex flex-1 rounded-t-2xl bg-white overflow-hidden">
        {/* sidebar */}
      ...
      <button
        ...
        className="fixed bottom-6 mobile:bottom-24 right-6 rtl:right-auto rtl:left-6 z-50 p-4 bg-primary-600 text-white rounded-full shadow-lg hover:bg-primary-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center justify-center group"
